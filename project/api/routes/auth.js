...
const { newvalidation } = require("../utils/UserValidation.js");
let errorData;
...
const { newauth, newlogin, csvAuth, googlelogin, googleopen, manuallyAddUser, updateUserType, deleteUser, finduserById, multeradd, addbyMulter } = require('../controller/Auth.js');
const { register } = require('../utils/UserValidation.js');
